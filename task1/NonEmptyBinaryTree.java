...
public class NonEmptyBinaryTree <T extends Comparable<T>> extends BinaryTree<T> {
	...
	public BinaryTree<T> insert(T d) {
		...
		if (this.find(d)){
			...
			if (d.compareTo(this.data) < 0){
				this.left = new NonEmptyBinaryTree<>(d);
			} else if (d.compareTo(this.data) > 0){
				this.right = new NonEmptyBinaryTree<>(d);
			}
		} else if (this.size() != 1){
			if (d.compareTo(this.data) < 0){
	...
	public BinaryTree<T> delete(T d) {
		...
		if (d.compareTo(data) < 0){
			return new NonEmptyBinaryTree<T>(data, left.delete(d), right);
		} else if (d.compareTo(data) > 0){
			return new NonEmptyBinaryTree<T>(data, left, right.delete(d));
		} else {
			if (left.isEmpty() && right.isEmpty()){
				...
				T rightMin = right.smallest();
				return new NonEmptyBinaryTree<T>(rightMin, left, right.delete(rightMin));
			}
		}
		// ########## YOUR CODE ENDS HERE ##########
	}
...
//		BinaryTree<Integer> left = new NonEmptyBinaryTree<>(3);
////		BinaryTree<Integer> right = new NonEmptyBinaryTree<>(11);
////		BinaryTree<Integer> myTree = new NonEmptyBinaryTree<>(7, left, right);
////		System.out.println("Before insertion = "+ myTree.preOrderShow());
...
////				.insert(10)
////				.insert(15);
////		System.out.println("After insertion = " + myTree.preOrderShow());
////		System.out.println(myTree.treeshow());
////		myTree.delete(11);
////		System.out.println(myTree.treeshow());
